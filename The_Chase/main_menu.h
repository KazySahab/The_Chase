...
public:
	...
	std::shared_ptr<Sound>scary_welcome = std::make_shared<Sound>("welcome", false, 40);
	std::shared_ptr<Sound>menu_scroll = std::make_shared<Sound>("menu_up_down", false, 50);
	std::shared_ptr<Sound>menu_select = std::make_shared<Sound>("menu_open", false, 50);
